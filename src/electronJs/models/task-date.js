...
class TaskDate {
    ...
    static _isDateOlderThen7days(creationDate = '') {
        if (creationDate) {
            ...
            // diff7days milliSec = days * hours * min * sec * millisec
            const diff7days_milliSec = 7 * 24 * 60 * 60 * 1000;
            return currentSystemDate.getTime() - givenDate.getTime() >= diff7days_milliSec;
        }
